...
namespace MVCCrud2.Controllers
{
    public class CochesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Matricula,Modelo,Marca,Color")] Coche coche)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Matricula,Modelo,Marca,Color")] Coche coche)
        {
            if (id != coche.Id)
            {
                return NotFound();
